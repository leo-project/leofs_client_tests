...
#        tester.mpObject(Bucket, "test.simple.mp",  SmallTestF)
#        tester.mpObject(Bucket, "test.large.mp",   LargeTestF)
    
        # Head Object Test
        tester.headObject(Bucket, "test.simple",   SmallTestF)
        tester.headObject(Bucket, "test.large",    LargeTestF)
#        tester.headObject(Bucket, "test.simple.mp",SmallTestF)
...
def init(signVer, Host, Port, AccessKeyId, SecretAccessKey):
    global tester
    botocli = BotoClient(signVer, Host, Port, AccessKeyId, SecretAccessKey)
    tester = LeoFSTester(botocli)
